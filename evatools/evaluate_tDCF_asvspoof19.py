...
if __name__ == '__main__':
    ...
    msg_no_cfg = "Configuration file need to be specified. asv_score, cm_score_file"
    assert len(sys.argv)==3, msg_no_cfg
    asv_score, cm_score_file = sys.argv[1], sys.argv[2]
    # Replace CM scores with your own scores or provide score file as the first argument.
    asv_score_file =  '/data3/luchao/LA/ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.dev.gi.trl.scores.txt' #'scores/cm_dev.txt'
    # Replace ASV scores with organizers' scores or provide score file as the second argument.
    cm_score_file = '/data3/luchao/LA_spoof/scores/asv_dev.txt'
